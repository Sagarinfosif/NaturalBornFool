...
//        int glviewWidth = ((MyVideoEditorActivity)getContext()).getGLViewWidth();
//        int glviewHeight = ((MyVideoEditorActivity)getContext()).getGLViewHeight();
...
//            ((MyVideoEditorActivity)getContext()).setMeasureSurfaceView(this);
//        }else{
