...
import in.pureway.cinemaflix.adapters.Inner.UserProfileAdapter;
...
public class AdapterUploadedVideos extends RecyclerView.Adapter<AdapterUploadedVideos.ViewHolder> {
    Context context;
    ...
    public AdapterUploadedVideos(Context context, List<ModelMyUploadedVideos.Detail> list, Select select) {
...
//                                holder.visbilityHeartIVSIN.setVisibility(View.GONE);
        ...
        if (list.get(position).getVideoType().equalsIgnoreCase("1")) {
...
//
        ...
        holder.tv_hashtags_list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                select.hashTags(list.get(position).getId());
            }
        });
        ...
        holder.hashTagRV.setAdapter(new UserProfileAdapter(context, list.get(position).getHastagLists(), new UserProfileAdapter.Select() {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private LinearLayout ll_likes_video, ll_recycler_add, ll_duet_layout, ll_sounds_video_hme, ll_share, ll_comments, ll_download;
        private VideoView video_home;
        private TextView tv_name_video_home, tv_sound_video, tv_hashtags_list, tv_description, tv_likes_video_home, tv_comments_count, tv_followers_count, tv_follow;
...
//            visbilityHeartIVSIN = itemView.findViewById(R.id.visbilityHeartIVSIN);
            img_Side_menu.setVisibility(View.GONE);
