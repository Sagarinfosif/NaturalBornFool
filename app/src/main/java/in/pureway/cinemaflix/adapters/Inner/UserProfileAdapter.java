...
public class UserProfileAdapter extends RecyclerView.Adapter<UserProfileAdapter.MyViewHolder> {
    ...
    Context context;
    List<ModelMyUploadedVideos.Detail.HastagList> hashTagList;
    Select select;
    ...
    public UserProfileAdapter(Context context,  List<ModelMyUploadedVideos.Detail.HastagList> hashTagList, Select select) {
