...
public class AdapterSearchSoundPlayer extends RecyclerView.Adapter<AdapterSearchSoundPlayer.ViewHolder> {

    Context context;
    List<GetSoundDetailsPojo.Details.SoundVideo> list;
    Select select;
    ...
    public AdapterSearchSoundPlayer(Context context, List<GetSoundDetailsPojo.Details.SoundVideo> listSoundDetail, Select select) {
        this.context = context;
        this.list = listSoundDetail;
        this.select = select;
    }
