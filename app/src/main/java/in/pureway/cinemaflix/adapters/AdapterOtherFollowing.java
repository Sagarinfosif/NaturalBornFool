...
public class AdapterOtherFollowing extends RecyclerView.Adapter<AdapterOtherFollowing.ViewHolder> {

    Activity mcontext;
    List<ModelFollowers.Detail> list;
    AdapterFollowing.Select select;
    ...
    public AdapterOtherFollowing(Activity mcontext, List<ModelFollowers.Detail> list, AdapterFollowing.Select select) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        if (list.get(position).getFriendStatus()) {
            ...
            holder.btn_follow_user.setText(mcontext.getString(R.string.follow));
        }
        ...
        if (CommonUtils.userId(mcontext).equalsIgnoreCase(list.get(position).getFollowingUserId())) {
