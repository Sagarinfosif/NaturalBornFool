...
public class AdapterLikedVideoPlayer extends RecyclerView.Adapter<AdapterLikedVideoPlayer.ViewHolder> {
    ...
    public AdapterLikedVideoPlayer(Context context, List<ModelLikedVideos.Detail> listLikedvideo, Select select) {
        this.context = context;
        this.list = listLikedvideo;
        this.select = select;
    }
...
//                                holder.visbilityHeartIVSIN.setVisibility(View.GONE);
        ...
        Glide.with(context).load(list.get(position).getUserImage()).placeholder(context.getDrawable(R.drawable.ic_user1)).into(holder.img_poster);
