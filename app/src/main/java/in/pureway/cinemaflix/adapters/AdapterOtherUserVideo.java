...
public class AdapterOtherUserVideo extends RecyclerView.Adapter<AdapterOtherUserVideo.ViewHolder> {
    ...
    public AdapterOtherUserVideo(Context context, List<ModelMyUploadedVideos.Detail> list, Select select) {
