...
public class AdapterNotificationVideo extends RecyclerView.Adapter<AdapterNotificationVideo.ViewHolder> {

    Context context;
    List<NotificationVideoModel.Detail> list;
    Select select;
    ...
    public AdapterNotificationVideo(Context context, List<NotificationVideoModel.Detail> list, Select select) {
...
//        }));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private LinearLayout ll_likes_video, ll_duet_layout, ll_recycler_add, ll_sounds_video_hme, ll_share, ll_comments;
