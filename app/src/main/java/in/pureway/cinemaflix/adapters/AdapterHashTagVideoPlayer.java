...
import in.pureway.cinemaflix.adapters.Inner.HashTagListAdapter;
...
public class AdapterHashTagVideoPlayer extends RecyclerView.Adapter<AdapterHashTagVideoPlayer.ViewHolder> {
    ...
    public AdapterHashTagVideoPlayer(Context context, List<ModelHashTagsDetails.Details.HashtagVideo> listHashTag, Select select) {
        this.context = context;
        this.list = listHashTag;
        this.select = select;
    }
...
//                                holder.visbilityHeartIV.setVisibility(View.VISIBLE);
                                } else {
                                    holder.btn_like_video.setLiked(true);
//                                holder.visbilityHeartIV.setVisibility(View.GONE);
                                }
                            }
        ...
        if (list.get(position).getHashTag() != null) {
...
//                holder.visbilityHeartIV.setVisibility(View.VISIBLE);
        ...
        holder.hashTagRV.setAdapter(new HashTagListAdapter(context, list.get(position).getHastagLists(), new HashTagHomeListAdapter.Select() {
            @Override
...
//            visbilityHeartIV = itemView.findViewById(R.id.visbilityHeartIVSIN);
        }
    }
}
